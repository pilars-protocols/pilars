...
The choice of whether to store Collections as a single Storage Object (e.g. a directory or directory-like node in a file hierarchy) in a, or as a number of, [Storage Object]s might be influenced by several factors:
...
To comply with [Protocol 2.5], [Repository Collection] / [Repostory Object] relationships might be described using either exhaustive lists of members with a property, such as the Portland Common Data Model `pcdm:hasMember` property, or by referencing the containing Collection from another Collection or Repository Object using the equivalent `pcdm:memberOf`.
